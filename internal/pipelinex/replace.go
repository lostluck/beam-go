...
func Update(p *pipepb.Pipeline, values *pipepb.Components) (*pipepb.Pipeline, error) {
	...
	maps.Copy(ret.Components.Transforms, values.Transforms)
	maps.Copy(ret.Components.Pcollections, values.Pcollections)
	maps.Copy(ret.Components.WindowingStrategies, values.WindowingStrategies)
	maps.Copy(ret.Components.Coders, values.Coders)
	maps.Copy(ret.Components.Environments, values.Environments)
